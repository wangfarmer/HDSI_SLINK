...
DEFAULT_SCHOOL_CONFIGS: dict[str, SchoolConfig] = {
    ...
    "boston_childrens_hospital": SchoolConfig(
        key="boston_childrens_hospital",
        name="Boston Children's Hospital Research",
        seed_urls=["https://research.childrenshospital.org/researchers"],
        allowed_domains=["research.childrenshospital.org"],
        profile_link_patterns=[r"/researchers/"],
        exclude_link_patterns=[r"#"],
        profile_required_patterns=[r"/researchers/[^/?]+$"],
        list_page_patterns=[r"/researchers\?page=\d+$"],
    ),
    "harvard_data_science_initiative": SchoolConfig(
        key="harvard_data_science_initiative",
        name="Harvard Data Science Initiative",
        seed_urls=["https://datascience.harvard.edu/people/"],
        allowed_domains=["datascience.harvard.edu"],
        profile_link_patterns=[r"/directory/"],
        exclude_link_patterns=[r"#"],
        profile_required_patterns=[r"/directory/[^/?]+"],
    ),
